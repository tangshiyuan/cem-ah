...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCHS):
        ...
        for theta in thetas_eval:
            ...
            test_batch = utils.iterate_model_batchesWB_msCEM2_reacher(env, model, theta, agent_start_list, MAX_STEPS, 1, SPARSE_REWARD, SCREEN_SHOT, use_cuda, device)
        ...
        for theta in thetas:
            ...
            batch = utils.iterate_model_batchesWB_msCEM2_reacher(env, model, theta, agent_start_list, MAX_STEPS, 1, SPARSE_REWARD, SCREEN_SHOT, use_cuda, device)
