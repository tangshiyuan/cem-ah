...
if __name__ == '__main__':
    ...
    if LAYER == 4:
        model = models.NetW_4Layer(args, obs_size, n_actions)  # 4-layer
    ...
    for epoch in range(EPOCHS):
        ...
        for theta in thetas_eval:
            ...
            test_batch = utils.iterate_model_batchesWB_msCEM2_bullet(env, model, theta, agent_start_list, 1,
                                                                use_cuda, device)
        ...
        for theta in thetas:
            ...
            batch = utils.iterate_model_batchesWB_msCEM2_bullet(env, model, theta, agent_start_list, 1,
                                                                use_cuda, device)
