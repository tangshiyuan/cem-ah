...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCHS):
        ...
        for state_num, agent_start in enumerate(agent_start_list):
            ...
            batch = utils.iterate_model_batches_net_Rstep(env, model, 10, use_cuda, device)  # NET_BATCH
        ...
        for state_num, agent_start in enumerate(agent_start_list):
            ...
            batch = utils.iterate_model_batches_net_Rstep(env, model, 1, use_cuda, device)  # NET_BATCH
        ...
        # normalize all_rewards_v to range 0-1 (avoid negative reward)
